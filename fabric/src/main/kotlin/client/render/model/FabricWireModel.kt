...
class FabricWireModel(
    val particle: Sprite,
    val parts: FabricWireModelParts
    ...
    override fun emitBlockQuads(
        blockView: BlockRenderView, state: BlockState, pos: BlockPos, randomSupplier: Supplier<Random>,
...
data class FabricWireModelParts(val sides: Map<Direction, FabricWireModelPart>)

data class FabricWireModelPart(val center: Map<CenterVariant, Mesh>, val exts: Map<Pair<Direction, ExtVariant>, Mesh>)